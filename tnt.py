...
MOTS_CLES = ["Star Wars", "Led Zeppelin", "Esprits criminels", "internet", "web", "économie", "informatique", "ordinateur", "geek", "Linux"]

CHAINES_NON_RECUES = ["Canal+", "Canal+ Family", "Canal+ Cinema", "Canal+ Décalé", "Paris Première", "Paramount Channel", "RTL 9", "13e Rue", "AB1"]
